-- Function: list_events_later_than(bigint, bigint, bigint, bigint, bigint, bigint, bigint)

DROP FUNCTION list_events_later_than(bigint, bigint, bigint, bigint, bigint, bigint, bigint);

CREATE OR REPLACE FUNCTION list_events_later_than(
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION list_events_later_than(bigint, bigint, bigint, bigint, bigint, bigint, bigint)
  OWNER TO postgres;
