-- function get_ca_certificate_data(bigint)

drop function get_ca_certificate_data(bigint);

create or replace function get_ca_certificate_data(IN root_cert_id_in bigint, OUT certificate_data_out varchar)
as
$$
declare
	subject_id_ bigint;
