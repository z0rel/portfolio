...
import { DebouncedSelectProps, GetQueryVariablesType } from './utils';
...
export const DebouncedInput = ({
  ...
  useEffect(() => {
    if (componentIsMounted === undefined || componentIsMounted?.current)
      getQueryData({ variables: (getQueryVariables as GetQueryVariablesType)(debouncedSearchTerm) });
  }, [debouncedSearchTerm, getQueryData, loading, refetchOnChangeThisVar, componentIsMounted, getQueryVariables]);
