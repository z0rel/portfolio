...
inline BOOL islow(STATE s)        { return (static_cast<int>(s) & SP_MASK) == SP_LOW; }
inline BOOL ishigh(STATE s)       { return (static_cast<int>(s) & SP_MASK) == SP_HIGH; }
inline BOOL isfloating(STATE s)   { return (static_cast<int>(s) & SP_MASK) == SP_FLOAT; }
inline BOOL iscontention(STATE s) { return  static_cast<int>(s) & SF_CONTENTION; }
inline BOOL isdefined(STATE s)    { return  static_cast<int>(s) != SP_UNDEFINED; }
inline BOOL ishighlow(STATE s)    { return  static_cast<int>(s) & 1; }
inline INT  polarity(STATE s)     { return  static_cast<int>(s) & SP_MASK; }
inline INT  strength(STATE s)     { return  static_cast<int>(s) & SS_MASK; }
